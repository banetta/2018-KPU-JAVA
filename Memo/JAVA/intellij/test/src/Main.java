...
class MyFrame extends JFrame implements ActionListener{
    ...
    public MyFrame(){				//생성자 정의
        ...
        this.setSize(400,400);			//프레임 크기 정의
    ...
    public void actionPerformed(ActionEvent e) {	        	 //액션이벤트 처리
        if(e.getSource() == this.order_button){	   //액션소스 검출 '주문 버튼시
            if(this.TypePanel.combo.isSelected()){	 //라디오 버튼 검사
                temp1 = 100;		  //해당 라디오 버튼 눌렷을 경우
            }			       //각 라이오 버튼의 비용을 임시저장
            ...
            sum = temp1 + temp2 + temp3;		//총 가격 합계 저장
